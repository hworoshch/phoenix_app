...
config :phoenix_app, PhoenixAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "6xlZAerjXgexN4n4YWnzAtmUOarpSmcVCQ7hXv+6kJi2vilU0TiEKjh5hRvaciwc",
  watchers: [
...
config :phoenix_app, PhoenixAppWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/phoenix_app_web/router\.ex$"E,
      ~r"lib/phoenix_app_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
